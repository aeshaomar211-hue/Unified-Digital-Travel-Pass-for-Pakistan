...
import { generateFallbackItinerary } from '@/lib/ai/fallback-generator'
...
- Be specific and practical, not generic.`,
      ...
      console.log('[v0] AI generation failed, using fallback:', aiError instanceof Error ? aiError.message : aiError)
      
      // Fallback to rules-based generator
      ...
      return { success: true, itinerary: fallbackItinerary }
    }
  } catch (error) {
